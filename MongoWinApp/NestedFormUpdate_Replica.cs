...
{
    public partial class NestedFormUpdate_Replica : Form
    {
        private IMongoDatabase database;

        public NestedFormUpdate_Replica()
        {
            InitializeComponent();

            this.AutoScaleMode = AutoScaleMode.Dpi;  // Scale based on DPI
            this.MinimumSize = new Size(800, 600);   // Prevent shrinking below 800x600

            // ✅ Layout Fixes
            comboBoxCollections.Anchor = AnchorStyles.Top | AnchorStyles.Left | AnchorStyles.Right;
            comboBoxFields.Anchor = AnchorStyles.Top | AnchorStyles.Left | AnchorStyles.Right;
            comboBoxFields1.Anchor = AnchorStyles.Top | AnchorStyles.Left | AnchorStyles.Right;
            comboBoxFields2.Anchor = AnchorStyles.Top | AnchorStyles.Left | AnchorStyles.Right;

            txtBoxfield.Anchor = AnchorStyles.Top | AnchorStyles.Left | AnchorStyles.Right;
            txtBoxfield1.Anchor = AnchorStyles.Top | AnchorStyles.Left | AnchorStyles.Right;
            txtBoxfield2.Anchor = AnchorStyles.Top | AnchorStyles.Left | AnchorStyles.Right;

            btnLoadCollections.Anchor = AnchorStyles.Bottom | AnchorStyles.Right;
